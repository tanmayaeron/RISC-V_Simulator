...
The Project also aims to give updates to the user regarding each step of the execution of the program.
The user can also choose the Inst and Data Replacement policy, Data and Inst Cache size. 
