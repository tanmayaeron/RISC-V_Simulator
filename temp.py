...
class Processor:
    ...
    f alu_caller(self, machine_code):
...
if __name__=='__main__':
    ...
    # if format == 'R':
        #     self.R_format(info_code)
        # elif format == 'I':
        #     self.I_format(info_code)
        # elif format == "S":
        #     self.obj.muxY = 0
        #     self.S_format(info_code)
        # elif format == "SB":
        #     self.obj.muxY = 2  # pc+=imm
        #     self.SB_format(info_code)
        # elif format == "U":
        #     self.obj.muxY = 0  # doubt
        #     self.U_format(info_code)
        # else:
        #     self.obj.muxY = 2
        #     self.UJ_format(info_code)
